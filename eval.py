...
from keras import layers, models, preprocessing, regularizers
from tensorflow.python.framework.ops import disable_eager_execution

from dqn import DQN, SoftMax
...
# %%
def load_model(dqn, checkpoint):
    filename = f"dqn-{checkpoint}.hd5"
    print("load model {}".format(filename))

    dqn.model = models.load_model(filename, custom_objects={"SoftMax": SoftMax})
    dqn.name = "dqn"
    dqn.checkpoint = checkpoint
...
# %%
frames, raw_frames, total_r = create_gif(dqn)
